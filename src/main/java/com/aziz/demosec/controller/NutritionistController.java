...
public class NutritionistController {
    ...
    @GetMapping
    public ResponseEntity<java.util.List<NutritionistProfileResponse>> getAllNutritionists() {
        java.util.List<NutritionistProfileResponse> list = nutritionistRepository.findAll().stream()
                .filter(Nutritionist::isEnabled)
                .map(this::mapToResponse)
    ...
    @GetMapping("/{id}")
    public ResponseEntity<NutritionistProfileResponse> getNutritionist(@PathVariable("id") Long id) {
